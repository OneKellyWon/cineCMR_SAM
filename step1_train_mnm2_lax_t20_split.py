...
trial_name = "mnm2_lax_3class_t20_train300_e50_trial"
...
start_epoch = 1
total_training_epochs = 50 # define total number of epochs
...
# define MnM2 LAX training data
patient_list_file_lax = main_path + "/example_data/data/Patient_list/patient_list_mnm2_lax_t20_train300.xlsx"

# Smoke test: first run only 2 cases.
patient_index_list = np.arange(0, 300, 1)
