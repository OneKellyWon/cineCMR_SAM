...
trial_name = 'mnm2_lax_3class_t20_e10_trial'
...
start_epoch = 1
total_training_epochs = 10 # define total number of epochs
...
patient_list_file_lax = os.path.join(
    main_path,
    'example_data/data/Patient_list/patient_list_mnm2_lax_t20.xlsx'
)

# Smoke test: first run only 2 cases.
patient_index_list = np.arange(0, 360, 1)
